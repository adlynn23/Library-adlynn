...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom px-4">
    <div class="container">
    <a class="navbar-brand" href="#">EduSpace.</a>
    ...
    <nav class="top-admin-nav">
        <div style="display:flex; align-items:center; gap:12px;">
            
        </div>
        <ul class="admin-menu-horizontal">
            <li class="active">System Management</li>
            <li>Booking Maintenance</li>
            <li>Analytics & Support</li>
        </ul>
        <div style="display:flex; align-items:center; gap:15px;">
            <div style="text-align:right;">
                <p style="margin:0; font-size:0.7rem;">Admin User</p>
                <p style="margin:0; font-weight:bold; font-size:0.9rem;">Administrator</p>
            </div>
        </div>
    </nav>

    <div style="margin-top: 140px; padding: 0 50px;">
...
<div class="admin-list-container">
    ...
    <script>
        ...
        function editRoom(n) { alert("Editing Room: " + n); }
        function deleteRoom(n) { if(confirm("Confirm DELETE " + n + "?")) alert("Deleted"); }
        function addRoom(f) { alert("Add room for " + f); }
        function logout() { if(confirm("Logout?")) window.location.href = 'login.jsp'; }
        function addFacility() { alert("Add Facility Modal"); }
        function editFacility(n) { alert("Editing Facility: " + n); }
        function switchTab(t) { if(t==='user') alert("Switch to User Management"); }
    </script>
